...
import { Tooltip, Area, AreaChart, LinearGradient, XAxis, YAxis, CartesianGrid } from 'recharts';
...
const SimpleLineChart = () => (
  <div className={sass.box_rechartd}>
    <AreaChart
      ...
      <Tooltip />
      <Area type="monotone" dataKey="پیامکی" stroke="#8884d8" fillOpacity={1} fill="url(#ccی')" />
      <Area type="monotone" dataKey="pv" stroke="#82ca9d" fillOpacity={1} fill="url(#colorPv)" />
      <Area type="monotone" dataKey="amt" stroke="#f1ca9d" fillOpacity={1} fill="url(#colorAmt)" />
    </AreaChart>
  </div>
);
