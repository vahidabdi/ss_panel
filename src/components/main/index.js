  ...
  return (
    <div>
      ...
      <Switch>
        ...
        <Route exact path="/dashboard/services/:page_id" component={RequireAuth(Services)} />
        ...
        <Route exact path="/dashboard/comments/:page_id" component={RequireAuth(Comments)} />
        <Route exact path="/dashboard/userList/:page_id" component={RequireAuth(UserList)} />
